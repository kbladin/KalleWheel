...
function updateThemeWithAppSkinInfo(appSkinInfo) {
    ...
    if(appName == "PHXS"){
	    addRule(styleId, "button, select, input[type=button], input[type=submit], checkbox, input[type=checkbox]", "border-radius:3px;");
	}
	if(appName == "PHXS" || appName == "PPRO" || appName == "PRLD") {
		...
		var none = "-webkit-appearance: none;";
		...
		// Checkbox
		addRule(styleId, ".custom-checkbox", none);
		addRule(styleId, ".custom-checkbox", gradientBg);
		addRule(styleId, ".custom-checkbox", borderColor);
		addRule(styleId, ".custom-checkbox", boxShadow);
		addRule(styleId, ".custom-checkbox:active, .custom-checkbox:checked:active", gradientHighlightBg);
		addRule(styleId, ".custom-checkbox:active, .custom-checkbox:checked:active", boxActiveShadow);
		addRule(styleId, ".custom-checkbox:checked", gradientHighlightBg);
		addRule(styleId, ".custom-checkbox:checked", boxActiveShadow);
